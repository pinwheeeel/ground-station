...
export default function Gallery() {
  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto px-4 mt-24 mb-24">
      <div
        className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden pt-10 pb-6 px-10 relative flex flex-col"
      ...
      >
          ...
          <div className="inline-flex rounded-lg border border-gray-300 bg-white shadow-sm p-1">
            <button
              ...
              className={`px-3 py-1 text-sm rounded-md transition-colors ${
                order === "asc" ? "bg-gray-900 text-white" : "text-gray-700 hover:bg-gray-100"
              }`}
            >
              Ascending
            </button>
            <button
              ...
              className={`ml-1 px-3 py-1 text-sm rounded-md transition-colors ${
                order === "desc" ? "bg-gray-900 text-white" : "text-gray-700 hover:bg-gray-100"
              }`}
            >
              Descending
            </button>
        ...
        >
          ...
          <GallerySection title={"Pinned"} photos={pinnedSlides} />
            ...
            .map((yearKey) => {
              ...
              return (
                <div key={year} className="mt-10 w-full">
                  ...
                  {sortedMonths.map((m) => (
                    <GallerySection key={m.title} title={m.title} photos={m.slides} />
                  ))}
                </div>
              );
            })}
