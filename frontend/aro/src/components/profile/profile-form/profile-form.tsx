    ...
    <div className="flex w-auto h-[calc(100vh-7rem)] max-h-full max-w-screen justify-center items-center-safe mt-24 mx-4 p-4 overflow-auto">
      <div className="flex flex-wrap items-center justify-evenly max-w-full h-fit rounded-2xl bg-white gap-4 p-6">
        ...
        <div className="flex flex-col w-60 max-w-full items-center h-fit max-h-full gap-2">
          ...
          <label
            htmlFor="pfp-upload"
            className="w-full max-w-full px-2 py-1 transition-colors hover:bg-gray-200 text-gray-900 border-black border rounded-lg text-center cursor-pointer shadow"
          >
            Edit profile image
          </label>
          <input
          ...
          {fileName /* only load file name and upload button once file is received */ && (
            <div className="flex flex-wrap items-center justify-center h-fit w-full gap-2">
              ...
              <button
                ...
                className="size-fit px-2 py-1 rounded-lg transition-colors bg-gray-900 hover:bg-gray-700 shadow"
              >
                Upload
              </button>
            </div>
        ...
        <form
          ...
          className="flex flex-col items-end w-xl h-fit p-1 gap-4 overflow-x-auto"
        >
          <label className="w-full text-2xl font-medium text-black wrap-break-word">
            Edit information
          </label>
          ...
          <div className="flex flex-col w-full h-auto gap-2">
            ...
            <div className="flex flex-wrap w-full gap-x-4 gap-y-2">
              <div className="field-label-container grow shrink">
                ...
                <input
                  ...
                  defaultValue={inputDefaults.fname}
                />
              </div>
              <div className="field-label-container grow shrink">
                ...
                <input
                  ...
                  className="form-field"
                  defaultValue={inputDefaults.lname}
                />
              </div>
            </div>
            ...
            <div className="field-label-container">
              ...
              <input
                ...
                placeholder="Email"
                className="form-field"
                defaultValue={inputDefaults.email}
              />
            </div>
            ...
            <div className="field-label-container">
              ...
              <input
                ...
                placeholder="Phone"
                className="form-field"
                defaultValue={inputDefaults.phone}
              />
            </div>
            ...
            <div className="field-label-container">
              ...
              <input
                ...
                className="form-field"
                defaultValue={inputDefaults.callsign}
              />
            </div>
          </div>
          ...
          <div className="flex flex-wrap size-fit gap-x-3 gap-y-1">
            <button
              type="submit"
              className="form-buttons transition-colors bg-gray-900 hover:bg-gray-700 shadow"
            >
              Submit
            </button>
